			...
			<div align="center">
				...
				<table border="0" width="80%" height="80%" align="center">
						<tr>
							...
							<input type="hidden" name="mem_mode" value="사업자"></td>
						...
						<tr>
							...
							<button type="button" class="btn btn-secondary btn-sm" onclick="window.location='admin_member_list.do?view=b'">취소</button>
							</td>	
						</tr>
				</table>
				</form>
