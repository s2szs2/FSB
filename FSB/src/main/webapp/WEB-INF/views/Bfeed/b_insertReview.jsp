...
<!-- 사이드 바 -->
		...
		<div class="d-flex flex-column align-items-stretch flex-shrink-0 bg-white" style="width: 800px;">
			<div class="d-flex align-items-center flex-shrink-0 p-3 border-bottom container">
				<div class="col" align="left"><span class="link-dark text-decoration-none fs-5 fw-semibold">리뷰 작성하기&nbsp;&nbsp;</span></div>
			</div>
				<form name="f" id="f" action="b_insertReview.do" method="post" enctype="multipart/form-data">
			...
			<table width="800px">
					...
					<tr align="center" height="60">
						...
						<td width="80%"><input type="text" class="form-control" name="bpr_title" placeholder="제목을 작성해주세요.(최대 50자)"></td>
					</tr>
					<tr align="center" height="60">
						<th  width="20%">리뷰 내용</th>
						<td width="80%"><textarea name="bpr_content" class="form-control" id="bpr_content" rows="7" placeholder="내용을 50자 이상 입력해주세요."></textarea></td>
					</tr>
					<tr align="center">
						<th width="20%" rowspan="2" align="center">사진 첨부</th><!-- Ajex 활용해서 업로드하기!!!<<<해야함 -->
