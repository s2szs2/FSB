...
<body>
	...
	<div class="card border-primary mb-3 mb-3 p-3 position-absolute top-50 start-0 translate-middle-y" style="max-width: 12rem; margin: 100px 100px;">
      <ul class="list-group list-group-flush">
   <li class="list-group-item"><a href="board_free.do?mode=" class="link-info link-offset-2 link-underline-opacity-25 link-underline-opacity-100-hover">자유게시판</a></li>
    <li class="list-group-item"><a href="board_secondhand.do?mode=all"class="link-info link-offset-2 link-underline-opacity-25 link-underline-opacity-100-hover">중고게시판</a></li>
    <li class="list-group-item"><a href="board_anony.do?mode=anony"class="link-info link-offset-2 link-underline-opacity-25 link-underline-opacity-100-hover">익명게시판</a></li>
  </ul>
	</div>
	</div>
		<div class="d-flex flex-column align-items-stretch flex-shrink-0 bg-white" style="width:900px; min-width: 30rem;">
	<div align="center"><b>자 유 게 시 판</b></div>
	<br>
	<br>
