...
<div class="d-flex justify-content-center">
	<div class="container px-1 py-4">
		<h5 class="border-bottom"><b>새 배송지 추가</b></h5><br>
			<form name="f" action="shop_insertDel.do" method="post">
				<table class="table" border="1" width="100%" align="center" style="font-size:12pt">
					...
					<tr valign="middle">
						...
						<td><input type="text" class="form-control" name="del_address1" id="sample6_postcode" placeholder="우편 번호"></td>
						<td><button class="btn btn-outline-dark" type="button" onclick="sample6_execDaumPostcode()">우편번호검색</button></td>
					</tr>		
					<tr valign="middle">
						<td><input type="text" class="form-control" name="del_address2" id="sample6_address" placeholder="주소"></td>
					</tr>
					<tr valign="middle">
						<td><input type="text" class="form-control" name="del_address3" id="sample6_detailAddress" placeholder="상세 주소"></td>
					</tr>	
					<tr valign="middle">
					...
					<tr valign="middle">
						...
						<td><input type="text" class="form-control" name="del_hp"></td><td> </td>
					</tr>
				</table>
				<div align="center">
